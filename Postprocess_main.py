...
def Fig1_sub2(DS, SS, MSS):
    ...
    hourly_SS_txDS = np.average(SS_txDS.reshape(-1, 24), axis=0)
    hourly_SS_hxDS = np.average(SS_hxDS.reshape(-1, 24), axis=0)
    hourly_SS_1xDS = np.average(SS_1xDS.reshape(-1, 24), axis=0)
    hourly_SS_2xDS = np.average(SS_2xDS.reshape(-1, 24), axis=0)
    ax2 = plt.subplot(122)
    ax2.plot(np.arange(24), np.r_[hourly_DS[5:], hourly_DS[:5]], color='black')
    ax2.plot(np.arange(24), np.r_[hourly_SS_txDS[5:], hourly_SS_txDS[:5]], color='mistyrose')
    ax2.plot(np.arange(24), np.r_[hourly_SS_hxDS[5:], hourly_SS_hxDS[:5]], color='pink')
    ax2.plot(np.arange(24), np.r_[hourly_SS_1xDS[5:], hourly_SS_1xDS[:5]], color='red')
